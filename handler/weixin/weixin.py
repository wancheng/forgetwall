...
def help_info(msg):
    ...
    item2 = NEWSITEM_TPL % (u"员工身份绑定","","http://www.forgetwall.com/static/img/a.png","http://www.forgetwall.com/weixin/binding?weixinid=%s" % msg['FromUserName'])
    item3 = NEWSITEM_TPL % (u"最新职位","","http://www.forgetwall.com/static/img/3.png","http://www.forgetwall.com/weixin/jobs.htm?method=list&weixinid=%s" % msg['FromUserName'])
